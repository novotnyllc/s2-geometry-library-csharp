 ...
 */
   ...
   * v2, ... and returns a bool value indicating whether each edge intersects
  ...
  public class LongitudePruner {
    ...
    public bool intersects(S2Point v1) {
      ...
      bool result = interval.intersects(S1Interval.fromPointPair(lng0, lng1));
      lng0 = lng1;
      return result;
    }
  }
  ...
  public  class WedgeIntersects : S2EdgeUtil.IWedgeRelation {
    /**
     * Given two edge chains (see WedgeRelation above), this function returns -1
  ...
  public class WedgeContainsOrCrosses : S2EdgeUtil.IWedgeRelation {
    /**
     * Given two edge chains (see WedgeRelation above), this function returns +1
